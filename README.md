...
Cinnamon is a chess program for Windows, Linux, Mac OS, Android and Raspberry Pi, is a console-based chess engine for use with [xboard][4],    [Arena][5],    [Tarrasch][6],    [Chess for Android][7]    or any UCI-compatible UI. Cinnamon is also a javascript library to play with  [chessboardjs][8] or any js GUI.
